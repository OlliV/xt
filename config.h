 ...
 */
static char font[] = configFONT;
static int borderpx = configBORDERPX;
static char shell[] = configSHELL;
static char *utmp = NULL;
#if configICON != 0
static char icon_file[] = configICON_FILE;
#endif
 ...
 */
static char worddelimiters[] = configWORDDELIMITERS;

/* selection timeouts (in milliseconds) */
static unsigned int doubleclicktimeout = configDOUBLECLICKTIMEOUT;
static unsigned int tripleclicktimeout = configTRIPLECLICKTIMEOUT;

/* alt screens */
static bool allowaltscreen = configALLOWALTSCREEN;

/* frames per second st should at maximum draw to the screen */
static unsigned int xfps = configXFPS;
static unsigned int actionfps = configACTIONFPS;

/*
 * blinking timeout (set to 0 to disable blinking) for the terminal blinking
 * attribute.
 */
static unsigned int blinktimeout = configBLINKTIMEOUT;

/*
 * bell volume. It must be a value between -100 and 100. Use 0 for disabling
 * it
 */
static int bellvolume = configBELLVOLUME;

/* TERM value */
static char termname[] = configTERMNAME;

static unsigned int tabspaces = configTABSPACES;
 ...
 */
static unsigned int defaultfg = configCDEFAULTFG;
static unsigned int defaultbg = configCDEFAULTBG;
static unsigned int defaultcs = configCDEFAULTCS;
 ...
 * complex.
 */
static unsigned int defaultitalic = configCDEFAULTITALIC;
static unsigned int defaultunderline = configCDEFAULTUNDERLINE;
